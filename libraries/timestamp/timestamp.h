...
#define  UNIX_TIMESTAMP ( __DATE_TIME_Y2K__ + Y2K_UNIX_EPOCH_DIFF + 61936)
// something wrong with the above, our compiler is always 17 hours behind so adding 61936 fixes that
